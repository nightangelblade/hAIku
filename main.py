...
if __name__ == "__main__":
    ...
    GEMINI_ROWS = {OutputCSVColumns.SOURCE: "Gemini", OutputCSVColumns.DATE: datetime.now().isoformat(), OutputCSVColumns.LINE_1: gemini_haiku[0], OutputCSVColumns.LINE_2: gemini_haiku[1], OutputCSVColumns.LINE_3: gemini_haiku[2]}
